...
exports.getCompanyData = async function (req, res) {
    ...
    try {
        ...
        console.log(error);
        res.send({ 'code': 204, 'message': 'Database Failure' })
        return
    }
    ...
    if (name != "") {
        ...
        res.send({ 'code': 204, 'message': 'Company already exists in database' })
        return
    }
    else {
        // companyName = req.body.companyName,
        ...
        //     });
        // });
        res.send({ 'code': 200, 'message': 'Company not in Database' })
    }
}
